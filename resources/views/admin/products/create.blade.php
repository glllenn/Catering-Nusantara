            ...
            <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 md:p-8">
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="event_category" name="event_category" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-orange-500 focus:ring-orange-500 text-sm">
                                    <option value="Kantor" {{ old('event_category') == 'Kantor' ? 'selected' : '' }}>Kantor / Rapat</option>
                                    <option value="Pernikahan" {{ old('event_category') == 'Pernikahan' ? 'selected' : '' }}>Pernikahan</option>
                                    ...
                                    <option value="Umum" {{ old('event_category', 'Umum') == 'Umum' ? 'selected' : '' }}>Umum</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="price" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-orange-500 focus:ring-orange-500 text-sm" type="number" name="price" :value="old('price')" required placeholder="25000" />
                            </div>

                            {{-- Minimal Order --}}
                            <div>
                                <x-input-label for="min_order" :value="__('Minimal Order (Porsi)')" />
                                <x-text-input id="min_order" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-orange-500 focus:ring-orange-500 text-sm" type="number" name="min_order" :value="old('min_order', 20)" required />
                            </div>
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea id="main_menu" name="main_menu" rows="2" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-orange-500 focus:ring-orange-500 text-sm" required placeholder="Ayam Goreng Lengkuas, Sambal Goreng Ati, Tempe Orek, Sayur Asem">{{ old('main_menu') }}</textarea>
                            </div>

                            <div>
                                <x-input-label for="includes" :value="__('Termasuk (Nasi / Minuman / Buah)')" />
                                <x-text-input id="includes" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-orange-500 focus:ring-orange-500 text-sm" type="text" name="includes" :value="old('includes')" placeholder="Nasi putih, Air mineral 220ml, Buah potong segar" />
                            </div>

                            <div>
                                <x-input-label for="description" :value="__('Deskripsi Singkat')" />
                                <textarea id="description" name="description" rows="3" class="block mt-1 w-full rounded-xl border-gray-200 focus:border-orange-500 focus:ring-orange-500 text-sm" placeholder="Jelaskan keunggulan rasa dan variasi masakan paket ini...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pt-6 border-t border-gray-100">
                        ...
                        <div class="space-y-4">
                            <div>
                                <x-input-label for="image" :value="__('Foto Paket Menu')" />
                                ...
                                <p class="text-xs text-gray-400 mt-1">Format: JPG, PNG, WEBP (Maksimal 10MB)</p>
                            </div>

                            <div class="flex flex-col sm:flex-row gap-6 pt-2">
                                <div class="flex items-center">
                                    <input id="is_bestseller" type="checkbox" name="is_bestseller" value="1" class="rounded border-gray-300 text-orange-600 shadow-sm focus:ring-orange-500" {{ old('is_bestseller') ? 'checked' : '' }}>
                                ...
                                <div class="flex items-center">
                                    <input id="is_active" type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-orange-600 shadow-sm focus:ring-orange-500" {{ old('is_active', '1') == '1' ? 'checked' : '' }}>
